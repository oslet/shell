...
if [ "$REPLY" == "help" ]; then
    echo
    echo "Please select a Star Wars move; enter \"quit\" to quit,"
    echo "or typye \"help\" for help. Press ENTER to list the options."
    echo
